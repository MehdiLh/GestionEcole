...
public class Menu extends JPanel {
    ...
    private void init() {
        ...
        add(scroll);
        addTitle("Groupe IPIRNET");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.DASHBOARD, "Dashboard"));
        addTitle("System");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.MAIL_OUTLINE, "Inscription", "Stagiare", "Formateur"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.MESSAGE, "Stage", "Stagiare", "Company"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.PERM_CONTACT_CALENDAR, "Seutenance"));
//        addTitle("COMPONENT");
...
//        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.ERROR_OUTLINE, "Error", "404", "500"));
    ...
    public void addTitle(String title) {
        ...
        label.setForeground(new Color(255,102,255));
        panelMenu.add(label);
    }
