...
import javaswingdev.form.Form_Stagiaire;
import javaswingdev.form.Form_Formateur;
import javaswingdev.form.Form_Stn;
import javaswingdev.form.Form_Stage;
import javaswingdev.form.Form_Company;
        ...
        menu.addEvent(new EventMenuSelected() {
            public void menuSelected(int index, int indexSubMenu) {
                if (index == 0 && indexSubMenu == 0) {
                    ...
                    showForm(new Form_Stagiaire());
                } else if(index == 1 && indexSubMenu == 2){
                    showForm(new Form_Formateur());
                } else if(index == 2 && indexSubMenu == 1) {
                    showForm(new Form_Stage());
                } else if(index == 2 && indexSubMenu == 2) {
                    showForm(new Form_Company());
                } else if(index == 3 && indexSubMenu == 0){
                    showForm(new Form_Stn());
                }
            }
            
            public void showFrame(String inscription) {
    ...
    private void initComponents() {
        ...
        backgroundLayout.setHorizontalGroup(
            ...
            .addGroup(backgroundLayout.createSequentialGroup()
                ...
                .addComponent(body, javax.swing.GroupLayout.DEFAULT_SIZE, 1160, Short.MAX_VALUE)
                .addContainerGap())
        );
